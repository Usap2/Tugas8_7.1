    ...
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"E:\22.61.0238\08\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
            ...
            // jika terjadi error di blok try, akan ditangani langsung oleh blokcatch
            catch (Exception ex)
            {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result > 0)
            {
                ...
                btnTampilkanData_Click(sender, e);
            }
            else
            {
